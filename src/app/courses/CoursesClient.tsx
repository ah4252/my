                    ...
                    <div className="h-56 relative overflow-hidden bg-slate-900">
                      ...
                      {(lesson.videoUrl?.includes("list=") || lesson.resources?.some((r: any) => r.url.includes("list="))) && (
                        <div className="absolute inset-0 z-20 flex items-center justify-center">
                          <div className="bg-red-600/90 text-white text-2xl font-black px-6 py-3 rounded-2xl shadow-2xl border-4 border-white/20 backdrop-blur-sm transform -rotate-12 tracking-widest animate-pulse">
                            PLAY LIST
                          </div>
                        </div>
                      )}
