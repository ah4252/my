...
function getEmbedUrl(url: string | null) {
  ...
  try {
    ...
    // Handle YouTube Videos (including shorts and mobile links)
...
export default async function LessonDetailsPage({ params }: { params: { slug: string } }) {
  ...
  // Smart URL selection: Prioritize main videoUrl, fallback to first video resource
  const mainUrl = lesson.videoUrl || lesson.resources.find(r => r.type === "VIDEO")?.url;
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-dark-card rounded-3xl p-6 shadow-sm border border-slate-200 dark:border-slate-800">
              ...
              <div className="space-y-3">
                {/* Static Old Resources (for compatibility) */}
                {lesson.pdfUrl && (
                  <a 
                    href={lesson.pdfUrl}
                    target="_blank"
